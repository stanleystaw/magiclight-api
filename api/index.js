    ...
    <div id="tab-video" class="tab-panel active">
      <div class="card">
        ...
        <div class="form-group">
          ...
          <textarea id="videoPrompt" placeholder="Ex: Un petit chaton blanc aux yeux bleus qui explore un jardin magique et rencontre des papillons dorés..."></textarea>
        </div>
        <div class="form-row">
          <div class="form-group">
        ...
        <div class="code-preview" id="videoUrlSnippet">Endpoint: POST /stanleystawa/video + GET /stanleystawa/status?task_id=...</div>
      </div>

      <div class="card">
        <div class="card-title">📺 Lecteur Vidéo HD & Suivi en Direct</div>
        <div class="preview-box" id="videoPreviewBox">
          <div class="preview-placeholder">La vidéo finale avec ses scènes, voix MagicLight TTS et sous-titres s'affichera ici.</div>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    async function generateVideo() {
      ...
      box.innerHTML = \`
        ...
        <div style="font-size: 12px; color: var(--text-muted);" id="progressDetail">Déclenchement du moteur GitHub Actions & FFmpeg...</div>
      \`;
      ...
      try {
        const initData = await safeFetchJson(\`\${getBaseUrl()}/stanleystawa/video\`, {
          ...
          body: JSON.stringify({ prompt, ratio, language })
        });
          ...
          try {
            ...
            if (statusData.status === "completed" && statusData.video_url) {
              ...
              box.innerHTML = \`
                ...
                <div class="meta-box">
                  <div><strong>Durée :</strong> \${statusData.duration}s | <strong>Scènes :</strong> \${statusData.scenes_count} | <strong>Filigrane :</strong> ❌ Aucun (Watermark-Free)</div>
              ...
              throw new Error(statusData.error || "Échec du rendu vidéo.");
            } else {
              const pct = statusData.progress || Math.min(95, 15 + attempts * 2);
