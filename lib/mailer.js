...
async function sendOtpEmail(toEmail, otpCode) {
  ...
  if (transporter) {
    try {
      ...
      return { sent: false, error: `Erreur d'authentification SMTP: ${err.message}` };
    }
  }
  ...
  return {
    sent: false,
    error: "Service d'envoi d'e-mail non configuré sur Vercel. Veuillez ajouter GMAIL_USER et GMAIL_PASS (Mot de passe d'application Google) ou RESEND_API_KEY dans vos variables d'environnement Vercel."
  };
}
