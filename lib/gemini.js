/**
 * lib/gemini.js — Intégration Native Google AI Studio (Gemini 2.0 / 1.5 Flash & Vision)
...
Réponds EXCLUSIVEMENT avec un objet JSON strict au format suivant :
{
  ...
  // --- 2. ANALYSE VISUELLE DU PERSONNAGE (GEMINI VISION) ---
  async describeCharacter(imageBase64) {
    ...
    try {
          ...
          contents: [
            {
              ...
              parts: [
                {
                  text: "Describe the character in this image concisely in English (e.g. 'A cute white bunny wearing red sunglasses' or 'A young knight with red cape and golden armor'). Reply with ONLY the short character description."
                },
                {
                  inlineData: {
                    mimeType: "image/jpeg",
      ...
      console.warn("[Gemini Describe Character Note]:", e.message);
    }
    return "The main character";
  }

  // --- 3. VISION & PROMPT ENHANCER POUR IMAGE / EDIT VIA GEMINI ---
