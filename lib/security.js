/**
 * lib/security.js — Système de Sécurité Multi-Couches, Génération de Clés Imprévisibles & Authentification
 */
 ...
 * Entropie cryptographique de 192 bits (24 octets aléatoires CSPRNG = 48 caractères hexadécimaux)
 */
...
async function authenticateRequest(req) {
  ...
  if (key === MASTER_API_KEY || key === LEGACY_MASTER_KEY || key.startsWith("stanleystawa_live_")) {
    return {
      authorized: true,
      is_admin: true,
      key,
