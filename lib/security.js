...
/**
 * Seul le GMAIL_USER configuré dans les variables d'environnement Vercel est Super Admin
 */
function isAdminEmail(email) {
  ...
  // Strictement le GMAIL_USER défini dans Vercel (ou SMTP_USER s'il correspond)
