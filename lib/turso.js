/**
 * lib/turso.js — Client Turso / libSQL HTTP v2 pour la gestion des comptes MagicLight
 */
...
class TursoDB {
  ...
  async deductCredits(email, amount = 5) {
    ...
    if (newCredits <= 0) {
      console.log(`[Turso] Compte ${email} à 0 crédit. Suppression automatique de Turso.`);
